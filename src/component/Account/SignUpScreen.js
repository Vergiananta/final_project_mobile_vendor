        ...
        <>
            <ImageBackground style={styles.picture} source={bgSrc} >
                <Animatable.View
                    ...
                    />
                            <Image source={bg} />
                            <Button onPress={selectPhotoTapped} > choose image</Button>
...
//     return {
//         handleInputChange: (inputName, inputValue) => dispatch({ type: INPUT_VENDOR, payload: { inputName, inputValue } }),
//         setLoading: () => dispatch({ type: SET_LOADING }),
//         submitComplete: () => dispatch({ type: SUBMIT_VENDOR }),
//         handleImageButton: (payload) => dispatch({ type: IMAGE_VENDOR, payload }),
//     }
// }
